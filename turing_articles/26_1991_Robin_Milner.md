# 图灵奖第二十六届 | Robin Milner:类型理论的诗人,并发计算的建筑师

> **一句话概括**:他创造了ML语言,让类型系统从"编译器的限制"变成了"程序员的助手";他发明了π演算和CCS,为并发系统提供了数学基础,影响了从Rust到Erlang的整个现代编程生态。

## 🏆 获奖简介

**Arthur John Robin Gorell Milner**(阿瑟·约翰·罗宾·戈雷尔·米尔纳,通常称Robin Milner)是英国计算机科学家,类型理论和并发理论的奠基人。
...
**为什么他是第二十六位?** Milner的工作横跨编程语言、形式化方法、并发理论三大领域,每一个都足以获奖。他不仅创造了强大的工具(ML语言),更建立了深刻的理论(类型推导、进程演算),将数学的优雅与工程的实用完美结合,深刻影响了整个软件工程的基础。
